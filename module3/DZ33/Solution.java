...
public class Solution {
    ...
    CollegeStudent collegeStudent2 = new CollegeStudent("Anton",3,"Oliyarnik",2,68);
    CollegeStudent collegeStudent3 = new CollegeStudent("Katya",2);
    ...
    SpecialStudent specialStudent3 = new SpecialStudent("Petro",1,"kpi",7,77);
    Student student1 = new Student("Alina","Yoga",5);
    Student student2 = new Student("Albina",1);
